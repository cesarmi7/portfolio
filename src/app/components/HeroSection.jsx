    ...
    <section className='grid grid-cols-1 sm:grid-cols-12'>
      <motion.div 
        ...
        <div>
          ...
          <a href="../../CesarResume.pdf" download className='px-1 py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-blue-600 via-purple-600 to-red-600 hover:bg-slate-800 text-white mt-3'>
